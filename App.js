...
class App extends Component {
  ...
  render(){
      const onShare = async () => {
        try {
          const result = await Share.share({
            message:
            'Tirei essa mensagem pelo biscoito da sorte e lembrei de você:' + this.state.textoFrase,
          });
      ...
      return(
          ...
          <TouchableOpacity style={styles.botao} onPress={ this.state.textoFrase == '' ? this.quebraBiscoito : this.limpar  }>
            <View style={styles.btnArea}>
              <Text style={styles.btnTexto}>{ this.state.textoFrase == '' ? 'Quebrar Biscoito' : 'Novo Biscoito' }</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity style={styles.botao} onPress={onShare}>
            <View style={styles.btnArea}>
              <Text style={styles.btnTexto}> Compartilhar </Text>
            </View>
          </TouchableOpacity>
